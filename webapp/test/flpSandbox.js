					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Administrar parceiros de negócio",
									"targetURL": "#bpbp99-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"bpbp99-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bp.bp99",
									"url": sap.ui.require.toUrl("bp/bp99")
								}
							}
						}
					}
